...
from plsno429.algorithms import RetryAlgorithm, TokenBucketAlgorithm, AdaptiveAlgorithm
...
class TestMinuteBoundaryRecovery:
    ...
    def test_minute_boundary_resets_tpm_tracking(self, mock_time):
        ...
        current_minute = int(1200.0 // 60)  # minute 20
        ...
        # Move to next minute
        mock_time.return_value = 1260.0  # 21:00.0
        next_minute = int(1260.0 // 60)  # minute 21
